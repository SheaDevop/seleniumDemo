...
describe("add some more text", function(){
  ...
  it("successfully adds more text to the text field and submit", async function(){
    ...
    await driver.findElement(By.id("elementToSelect")).sendKeys("Learn Selenium parallelization", Key.RETURN);
    ...
    fieldTextValue.should.equal("Learn Selenium parallelization")
